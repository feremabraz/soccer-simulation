...
export class SubstitutionSystem {
  ...
  makeSubstitution(
    ...
    const playerOutIndex = activePlayers.findIndex((p) => p.team === request.team && p.id === request.playerOut)
  ...
  suggestSubstitution(team: TeamSide, activePlayers: PlayerEntity[], gameTime: number): SubstitutionRequest | null {
