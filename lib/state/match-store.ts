...
import type { TeamData, GameState, GameEvent, EventType, TeamSide, Vector2D } from "../utils/types"
...
const setpieceAtom = atom<{ type: EventType | null; team: TeamSide | null; position: Vector2D | null }>({
  type: null,
  team: null,
  position: null,
})
